...
SPORT_SUBTAGS = {
    "Basketball": [
        ...
        ("NBA",          ["NBA","KXNBA","KXNBAMATCHUP","KXNBAWINS","KXRECORDNBABEST",
                          "KXNBATOPPICK","KXNBALOTTERYODDS","KXNBAEAST1SEED","KXNBAWEST1SEED",
                          "KXTEAMSINNBAF","KXTEAMSINNBAEF","KXNBAWFINMVP","KXNBAEFINMVP"]),
        ("Playoffs",     ["playoff","playin","KXNBAPLAYOFF","KXNBAPLAYIN"]),
        ("Draft",        ["draft","KXNBADRAFT","KXNBADRAFTPICK","KXNBADRAFTTOP","KXNBADRAFTCOMP","KXNBADRAFTCAT"]),
        ("Awards",       ["MVP","ROY","COY","DPOY","KXNBAMVP","KXNBAROY","KXNBACOY","KXNBADPOY",
                          "KXNBASIXTH","KXNBAMIMP","KXNBACLUTCH","KXNBAFINMVP","KXNBAWFINMVP","KXNBAEFINMVP"]),
        ("All-NBA Teams",["KXNBA1STTEAM","KXNBA2NDTEAM","KXNBA3RDTEAM","KXNBA1STTEAMDEF","KXNBA2NDTEAMDEF"]),
        ("Standings",    ["wins","east","west","atlantic","central","pacific","southeast","southwest","northwest",
                          "KXNBAWINS","KXNBAEAST","KXNBAWEST","KXNBAATLANTIC","KXNBACENTRAL","KXNBAPACIFIC",
                          "KXNBASOUTHEAST","KXNBASOUTHWEST","KXNBANORTHWEST"]),
        ("Stats Leaders",["KXLEADERNBA"]),
        ("International",["euroleague","KXEUROLEAGUEGAME","KXBSLGAME","KXBBLGAME","KXACBGAME",
                          "KXISLGAME","KXABAGAME","KXCBAGAME","KXBBSERIEAGAME","KXJBLEAGUEGAME",
                          "KXLNBELITEGAME","KXARGLNBGAME"]),
        ("NCAAB",        ["NCAAB","NCAAMB","KXMARMAD","KXNCAAMB","KXNCAAMBNEXTCOACH"]),
        ("WNBA",         ["WNBA","KXWNBA","KXWNBADRAFT1","KXWNBADRAFTTOP3","KXWNBADELAY","KXWNBAGAMESPLAYED"]),
        ("Other",        ["KXSONICS","KXSTEPHDEAL","KXLBJRETIRE","KXSPORTSOWNERLBJ","KXQUADRUPLEDOUBLE",
                          "KXCITYNBAEXPAND","KXNBASEATTLE","KXNEXTTEAMNBA","KXTEAMSINNBAWF","KXSHAI20PTREC"]),
    ],
    "Baseball": [

        ("MLB Games",    ["KXMLBGAME","KXMLBRFI"]),
        ("Standings",    ["KXMLBWINS","KXMLBALEAST","KXMLBALWEST","KXMLBALCENT","KXMLBNLEAST","KXMLBNLWEST","KXMLBNLCENT","KXMLBBESTRECORD","KXMLBWORSTRECORD","KXMLBLSTREAK","KXMLBWSTREAK"]),
        ("Awards",       ["KXMLBALMVP","KXMLBNLMVP","KXMLBALCY","KXMLBNLCY","KXMLBALROTY","KXMLBNLROTY","KXMLBEOTY","KXMLBALMOTY","KXMLBNLMOTY","KXMLBALHAARON","KXMLBNLHAARON","KXMLBALCPOTY","KXMLBNLCPOTY","KXMLBALRELOTY","KXMLBNLRELOTY"]),
        ("Playoffs",     ["KXMLBPLAYOFFS","KXTEAMSINWS","KXMLBAL","KXMLBNL"]),
        ("Stats Leaders",["KXLEADERMLB"]),
        ("Season Stats", ["KXMLBSTAT","KXMLBSTATCOUNT","KXMLBSEASONHR"]),
        ("Trades",       ["KXMLBTRADE"]),
        ("NCAA Baseball",["KXNCAABASEBALL","KXNCAABBGS"]),
        ("Other",        ["KXMLB"]),
        ("MLB Games",    ["KXMLBGAME","KXMLBRFI","KXMLBSTAT","KXMLBSTATCOUNT"]),
        ("Standings",    ["KXMLBWINS-","KXMLBALEAST","KXMLBALWEST","KXMLBALCENT","KXMLBNLEAST","KXMLBNLWEST","KXMLBNLCENT","KXMLBBESTRECORD","KXMLBWORSTRECORD","KXMLBLSTREAK","KXMLBWSTREAK"]),
        ("Awards",       ["KXMLBALMVP","KXMLBNLMVP","KXMLBALCY","KXMLBNLCY","KXMLBALROTY","KXMLBNLROTY","KXMLBEOTY","KXMLBALMOTY","KXMLBNLMOTY","KXMLBALHAARON","KXMLBNLHAARON","KXMLBALCPOTY","KXMLBNLCPOTY","KXMLBALRELOTY","KXMLBNLRELOTY"]),
        ("Playoffs",     ["KXMLBPLAYOFFS","KXTEAMSINWS","KXMLBAL","KXMLBNL","KXMLBSEASONHR"]),
        ("Stats Leaders",["KXLEADERMLB"]),
        ("Trades",       ["KXMLBTRADE"]),
        ("NCAA / Other", ["KXNCAABASEBALL","KXNCAABBGS","KXMLB","KXWSOPENTRANTS"]),
    ],
    "Football": [

        ("NFL Games",    ["KXUFLGAME"]),
        ("Super Bowl",   ["KXSB"]),
        ("Playoffs",     ["KXNFLPLAYOFF","KXNFLAFCCHAMP","KXNFLNFCCHAMP"]),
        ("Standings",    ["KXNFLAFCEAST","KXNFLAFCWEST","KXNFLAFCNORTH","KXNFLAFCSOUTH","KXNFLNFCEAST","KXNFLNFCWEST","KXNFLNFCNORTH","KXNFLNFCSOUTH"]),
        ("Awards",       ["KXNFLMVP","KXNFLOPOTY","KXNFLDPOTY","KXNFLOROTY","KXNFLDROTY","KXNFLCOTY"]),
        ("Draft",        ["KXNFLDRAFT","KXNFLDRAFTWR","KXNFLDRAFTDB","KXNFLDRAFTTE","KXNFLDRAFTQB","KXNFLDRAFTOL","KXNFLDRAFTEDGE","KXNFLDRAFTLB","KXNFLDRAFTRB","KXNFLDRAFTDT","KXNFLDRAFTTOP","KXNFLDRAFTPICK","KXNFLDRAFTTEAM","KXNFLDRAFT1","KXNFLDRAFT1ST"]),
        ("Stats Leaders",["KXLEADERNFL"]),
        ("NCAAF",        ["KXNCAAF","KXHEISMAN","KXNCAAFCONF","KXNCAAFACC","KXNCAAFB10","KXNCAAFB12","KXNCAAFSEC","KXNCAAFAAC","KXNCAAFSBELT","KXNCAAFMWC","KXNCAAFMAC","KXNCAAFCUSA","KXNCAAFPAC12","KXNCAAFPLAYOFF","KXNCAAFFINALIST","KXNCAAFUNDEFEATED","KXNCAAFCOTY","KXNCAAFAPRANK"]),
        ("Trades",       ["KXNFLTRADE","KXNEXTTEAMNFL"]),
        ("Coaches",      ["KXCOACHOUTNFL","KXCOACHOUTNCAAFB"]),
        ("Other",        ["KXNFLPRIMETIME","KXKELCERETIRE","KXSTARTINGQBWEEK1","KXSORONDO","KXARODGRETIRE","KXNFLTEAM1POS","KXRELOCATIONCHI","KX1STHOMEGAME","KXDONATEMRBEAST","KXNDJOINCONF","KXRECORDNFLBEST","KXRECORDNFLWORST","KXCOVEREA"]),
    ],
    "Hockey": [

        ("NHL Games",    ["KXNHLGAME","KXNHL","KXNHLSPREAD","KXNHLTOTAL","KXAHLGAME"]),
        ("Stanley Cup",  ["KXTEAMSINSC","KXNHLPLAYOFF"]),
        ("Standings",    ["KXNHLEAST","KXNHLWEST","KXNHLADAMS","KXNHLCENTRAL","KXNHLATLANTIC","KXNHLMETROPOLITAN","KXNHLPACIFIC"]),
        ("Awards",       ["KXNHLHART","KXNHLNORRIS","KXNHLVEZINA","KXNHLCALDER","KXNHLROSS","KXNHLRICHARD","KXNHLPRES"]),
        ("NCAA Hockey",  ["KXNCAAHOCKEY"]),
        ("Canada Cup",   ["KXCANADACUP"]),
        ("NHL Games",    ["KXNHLGAME","KXNHL","KXNHLSPREAD","KXNHLTOTAL","KXAHLGAME"]),
        ("Stanley Cup",  ["KXTEAMSINSC","KXNHLPLAYOFF"]),
        ("Standings",    ["KXNHLEAST","KXNHLWEST","KXNHLADAMS","KXNHLCENTRAL","KXNHLATLANTIC","KXNHLMETROPOLITAN","KXNHLPACIFIC"]),
        ("Awards",       ["KXNHLHART","KXNHLNORRIS","KXNHLVEZINA","KXNHLCALDER","KXNHLROSS","KXNHLRICHARD","KXNHLPRES"]),
        ("NCAA / Other", ["KXNCAAHOCKEY","KXCANADACUP"]),
    ],
    "Tennis": [

        ("Grand Slams",  ["KXGRANDSLAM","KXATPGRANDSLAM","KXWTAGRANDSLAM","KXATPGRANDSLAMFIELD","KXGRANDSLAMJFONSECA"]),
        ("ATP",          ["KXATPMC","KXMCMMEN","KXFOMEN","KXATPGAME","KXATPMATCH","KXATPSETWINNER",
                          "KXATPANYSET","KXATPEXACTMATCH","KXATPGAMESPREAD","KXATPGAMETOTAL",
                          "KXATPCHALLENGERMATCH","KXATPMAD","KXATPMIA","KXATPIWO","KXATPAMT",
                          "KXATPIT","KXATPMCO","KXATPFINALS","KXATPNEXTGEN"]),
        ("WTA",          ["KXFOWOMEN","KXWTASERENA","KXWTAGAME","KXWTAMATCH","KXWTADOUBLES",
                          "KXWTAMAD","KXWTAMIA","KXWTAIWO","KXWTAATX","KXWTAMOA","KXWTAIT",
                          "KXWTAFINALS","KXWTACHALLENGERMATCH"]),
        ("Rankings",     ["KXATP1RANK","KXATPRANK"]),
    ...
    "Golf": [
        ...
        ("Top Finishes", ["KXPGATOP","KXPGAPLAYOFF","KXPGACUTLINE","KXPGAWINNERREGION","KXPGALOWSCORE","KXPGASTROKEMARGIN","KXPGAWINNINGSCORE"]),
        ...
        ("The Masters",  ["KXPGAMASTERS","KXPGAR1LEAD","KXPGAR2LEAD","KXPGAR3LEAD","KXPGAR3TOP5","KXPGAR3TOP10","KXPGAH2H","KXPGA5BALL","KXPGAEAGLE","KXPGAHOLEINONE","KXPGABOGEYFREE","KXPGACUTLINE","KXPGATOP5","KXPGATOP10","KXPGATOP20","KXPGATOP40","KXPGAWINNERREGION","KXPGALOWSCORE","KXPGASTROKEMARGIN","KXPGAWINNINGSCORE","KXPGAPLAYOFF","KXPGAMAJORTOP10","KXPGAPLAYERCAT"]),
        ("Majors",       ["KXGOLFMAJORS","KXPGAMAJORWIN"]),
        ("Season",       ["KXPGATOUR","KXPGAMASTERS"]),
        ("Ryder Cup",    ["KXPGARYDER","KXPGASOLHEIM","KXRYDERCUPCAPTAIN"]),
        ("Player Props", ["KXPGACURRY","KXPGATIGER","KXBRYSONCOURSERECORDS","KXSCOTTIESLAM","KXGOLFTENNISMAJORS"]),
    ],
    "MMA": [
        ...
        ("UFC Events",   ["KXCARDPRESENCEUFCWH","KXUFCWHITEHOUSE"]),
    ],
    "Motorsport": [
        ...
        ("F1",           ["KXF1RACE","KXF1RACEPODIUM","KXF1TOP5","KXF1TOP10","KXF1FASTLAP","KXF1CONSTRUCTORS","KXF1RETIRE","KXF1","KXF1OCCUR","KXF1CHINA"]),
        ("NASCAR Cup",   ["KXNASCARCUPSERIES","KXNASCARRACE","KXNASCARTOP3","KXNASCARTOP5","KXNASCARTOP10","KXNASCARTOP20"]),
        ("NASCAR Other", ["KXNASCARTRUCKSERIES","KXNASCARAUTOPARTSSERIES"]),
...
SPORT_TAGS = [
    ...
    ("🎾","Tennis",["KXMCMMEN","KXFOWOMEN","KXGRANDSLAM","KXWTAGRANDSLAM","KXGOLFTENNISMAJORS","KXWTASERENA","KXATPGRANDSLAMFIELD","KXGRANDSLAMJFONSECA","KXFOMEN","KXATPGRANDSLAM","KXATP1RANK"]),
    ("⛳","Golf",["KXPGAR3LEAD","KXBRYSONCOURSERECORDS","KXPGAR1LEAD","KXPGAMAJORTOP10","KXPGAR2LEAD","KXPGA5BALL","KXPGAEAGLE","KXPGAHOLEINONE","KXGOLFMAJORS","KXPGAMAJORWIN","KXRYDERCUPCAPTAIN","KXPGAPLAYERCAT","KXPGAR3TOP5","KXPGABOGEYFREE","KXPGATOUR","KXPGACURRY","KXPGATOP40","KXGOLFTENNISMAJORS","KXPGAPLAYOFF","KXPGATIGER","KXPGASOLHEIM","KXPGAMASTERS","KXPGAH2H","KXPGATOP10","KXSCOTTIESLAM","KXPGARYDER","KXPGACUTLINE","KXPGAR3TOP10","KXPGATOP5","KXPGATOP20","KXPGAWINNERREGION","KXPGALOWSCORE","KXPGASTROKEMARGIN","KXPGAWINNINGSCORE"]),
    ("🥊","MMA",["KXUFCFLYWEIGHTTITLE","KXUFCBANTAMWEIGHTTITLE","KXUFCFIGHT","KXUFCMIDDLEWEIGHTTITLE","KXUFCHEAVYWEIGHTTITLE","KXUFCLIGHTWEIGHTTITLE","KXUFCFEATHERWEIGHTTITLE","KXUFCLHEAVYWEIGHTTITLE","KXMCGREGORFIGHTNEXT","KXUFCWELTERWEIGHTTITLE","KXCARDPRESENCEUFCWH","KXUFCWHITEHOUSE"]),
    ("🏏","Cricket",["KXIPLGAME","KXPSLGAME","KXPSL","KXIPL"]),
    ("🎮","Esports",["KXVALORANTMAP","KXLOLGAME","KXVALORANTGAME","KXR6GAME","KXLOLMAP","KXLOLTOTALMAPS"]),
    ("🏎️","Motorsport",["KXF1RACE","KXF1RACEPODIUM","KXNASCARTOP10","KXMOTOGPTEAMS","KXNASCARTOP20","KXF1OCCUR","KXINDYCARSERIES","KXNASCARTOP5","KXNASCARAUTOPARTSSERIES","KXF1TOP5","KXMOTOGP","KXF1FASTLAP","KXF1CONSTRUCTORS","KXNASCARTOP3","KXNASCARRACE","KXF1RETIRE","KXNASCARTRUCKSERIES","KXF1","KXNASCARCUPSERIES","KXF1TOP10","KXF1CHINA"]),
