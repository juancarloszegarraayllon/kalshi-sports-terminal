...
SPORT_SUBTAGS = {
    ...
    "Tennis": [
        ...
        ("Monte Carlo",   ["Monte Carlo","KXATPMC","KXMCMMEN","KXMCMEN"]),
        ("ATP Matches",   ["KXATPGAME","KXATPMATCH","KXATPSETWINNER","KXATPANYSET","KXATPEXACTMATCH",
                           ...
                           "KXATPCHALLENGERMATCH","KXCHALLENGERMATCH","KXATPMAD","KXATPMIA","KXATPMCO",
                           "KXATPIWO","KXATPAMT","KXATPIT","KXATPWDDF",
                           "KXROMENSSINGLES","KXROMENSDOUBLES","KXIWMEN","KXIWMENDOUBLES",
                           "KXMOMEN","KXDDFMENSINGLES","KXQEMOMENSSINGLES","KXO13MENSINGLES","KXFOMEN"]),
        ("WTA Matches",   ["KXWTAGAME","KXWTAMATCH","KXWTADOUBLES","KXWTACHALLENGERMATCH",
                           ...
                           "KXWTASERENA","KXFOWOMEN","KXIWWOMEN","KXMOWOMEN",
                           "KXDDFWOMENSINGLES","KXQOWOMENSINGLES","KXFOWOMENSINGLES"]),
        ...
        ("Team Events",   ["Davis Cup","Laver Cup","United Cup","Six Kings","KXDAVISCUP",
                           "KXLAVERCUP","KXUNITEDCUP","KXSIXKINGSSLAM","KXBATTLEOFSEXES","KXITFMATCH"]),
...
SPORT_TAGS = [
    ...
    ("🎾","Tennis",[
        ...
        # Individual ATP match series (one per tournament)
        ...
        "KXROMENSSINGLES","KXROMENSDOUBLES","KXIWMEN","KXIWMENDOUBLES","KXMOMEN",
        "KXDDFMENSINGLES","KXQEMOMENSSINGLES","KXO13MENSINGLES","KXFOMENSINGLES",
        # Individual WTA match series
        "KXWTAMAD","KXWTAMIA","KXWTAIWO","KXWTAATX","KXWTAMOA","KXWTAIT","KXWTADDF",
        "KXWTAGAME","KXWTAMATCH","KXWTADOUBLES","KXWTACHALLENGERMATCH",
        "KXIWWOMEN","KXMOWOMEN","KXDDFWOMENSINGLES","KXQOWOMENSINGLES","KXFOWOMENSINGLES",
        # Grand Slam specific
        "KXFOPENMENSINGLE","KXFOPENWMENSINGLE",
        "KXAOMENSINGLES","KXAOWOMEN",
        "KXUSOMENSINGLES","KXUSOWOMENSINGLES",
        "KXWMENSINGLES","KXWWOMENSINGLES",
        # Team events
...
SOCCER_COMP_MAP = {
    # EPL
    "KXEPLGAME":"EPL","KXEPL1H":"EPL","KXEPLSPREAD":"EPL","KXEPLTOTAL":"EPL","KXEPLBTTS":"EPL",
    "KXEPLTOP4":"EPL","KXEPLTOP2":"EPL","KXEPLTOP6":"EPL","KXEPLRELEGATION":"EPL",
    "KXPREMIERLEAGUE":"EPL","KXARSENALCUPS":"EPL","KXPFAPOY":"EPL",
    "KXNEXTMANAGERMANU":"EPL","KXWINSTREAKMANU":"EPL",
    # Champions League
    ...
    "KXUCLFINALIST":"Champions League","KXUCLRO4":"Champions League","KXLEADERUCLGOALS":"Champions League",
    "KXTEAMSINUCL":"Champions League",
    # Women's UCL (separate)
    "KXUCLW":"Women's UCL",
    # Europa League
    "KXUELGAME":"Europa League","KXUELSPREAD":"Europa League","KXUELTOTAL":"Europa League","KXUEL":"Europa League",
    # Conference League
    "KXUECL":"Conference League",
    # La Liga (top flight only)
    "KXLALIGAGAME":"La Liga","KXLALIGA1H":"La Liga","KXLALIGASPREAD":"La Liga","KXLALIGATOTAL":"La Liga",
    "KXLALIGABTTS":"La Liga","KXLALIGA":"La Liga","KXLALIGATOP4":"La Liga","KXLALIGARELEGATION":"La Liga",
    "KXLAMINEYAMAL":"La Liga","KXBALLONDOR":"La Liga",
    # La Liga 2 (second division — keep separate!)
    "KXLALIGA2GAME":"La Liga 2",
    # Serie A
    "KXSERIEAGAME":"Serie A","KXSERIEA1H":"Serie A","KXSERIEASPREAD":"Serie A","KXSERIEATOTAL":"Serie A",
    "KXSERIEABTTS":"Serie A","KXSERIEA":"Serie A","KXSERIEATOP4":"Serie A","KXSERIEARELEGATION":"Serie A",
    ...
    # Bundesliga 2 (second division — keep separate!)
    "KXBUNDESLIGA2GAME":"Bundesliga 2",
    # Ligue 1
    "KXLIGUE1GAME":"Ligue 1","KXLIGUE11H":"Ligue 1","KXLIGUE1SPREAD":"Ligue 1","KXLIGUE1TOTAL":"Ligue 1",
    "KXLIGUE1BTTS":"Ligue 1","KXLIGUE1":"Ligue 1","KXLIGUE1TOP4":"Ligue 1","KXLIGUE1RELEGATION":"Ligue 1",
    # MLS
    ...
    # Brasileiro
    "KXBRASILEIROGAME":"Brasileiro","KXBRASILEIROSPREAD":"Brasileiro","KXBRASILEIROTOTAL":"Brasileiro",
    "KXBRASILEIRO":"Brasileiro","KXBRASILEIROTOPX":"Brasileiro",
    # World Cup
    "KXWCGAME":"World Cup","KXWCROUND":"World Cup","KXWCGROUPWIN":"World Cup","KXWCGROUPQUAL":"World Cup",
    "KXWCGOALLEADER":"World Cup","KXWCMESSIRONALDO":"World Cup","KXWCLOCATION":"World Cup",
    "KXWCIRAN":"World Cup","KXWCSQUAD":"World Cup","KXMENWORLDCUP":"World Cup",
    "KXSOCCERPLAYMESSI":"World Cup","KXSOCCERPLAYCRON":"World Cup","KXFIFAUSPULL":"World Cup",
    "KXFIFAUSPULLGAME":"World Cup",
    # Saudi Pro League
    ...
    "KXFACUP":"FA Cup","KXCOPPAITALIA":"Coppa Italia","KXKNVBCUP":"KNVB Cup",
    # EFL Championship
    ...
    # South American
    "KXARGPREMDIVGAME":"Argentinian","KXDIMAYORGAME":"Colombian",
    ...
    # Transfers / News
    "KXSOCCERTRANSFER":"Transfers","KXJOINLEAGUE":"Transfers",
    "KXJOINRONALDO":"Transfers","KXJOINCLUB":"Transfers",
}
